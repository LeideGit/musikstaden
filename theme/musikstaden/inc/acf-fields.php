		...
		array(
			...
			'fields' => array(
				...
				array(
					...
					'type'         => 'email',
					'required'     => 1,
					'instructions' => 'E-postadress för bokningsförfrågningar. Visas inte publikt.',
					'placeholder'  => 'bokning@band.se',
				),
				array(
					'key'           => 'field_booking_inquiries_enabled',
					'label'         => 'Bokningsförfrågningar på artistsidan',
					'name'          => 'booking_inquiries_enabled',
					'type'          => 'true_false',
					'ui'            => 1,
					'default_value' => 1,
					'instructions'  => 'När avstängt döljs bokningsmodulen på den publika artistsidan.',
				),
				array(
